    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#667eea] to-[#764ba2] p-5">
      ...
      >
        <div className="text-center mb-8">
          <div className="bg-gradient-to-br from-[#4285f4] to-[#346ecbff] w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-[0_4px_16px_rgba(66,133,244,0.3)]">
        ...
        <Form.Item>
          <Button
            ...
            loading={loading}
            block
            className="bg-gradient-to-br from-[#4285f4] to-[#346ecbff] border-none rounded-lg h-12 text-base font-semibold shadow-[0_4px_16px_rgba(66,133,244,0.3)]"
            onClick={handleLogin}
          >
            Sign In
          </Button>
